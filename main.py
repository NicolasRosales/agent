...
from functions.write_files_info import schema_write_file
...
def main():
    ...
    if(len(sys.argv)<2):
        ...
        if len(sys.argv)==3 and sys.argv[2] and sys.argv[2] == "--verbose": #Esto no se corre si no tiene 3 argumentos o el tercero no es --verbose
